...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_openlayers__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__images_juhe_png__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__images_juhe_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__images_juhe_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__images_cr_png__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__images_cr_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__images_cr_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__images_lu_png__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__images_lu_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__images_lu_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__images_sms_png__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__images_sms_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__images_sms_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__images_cr_attention_png__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__images_cr_attention_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__images_cr_attention_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__images_lu_attention_png__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__images_lu_attention_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__images_lu_attention_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__images_sms_attention_png__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__images_sms_attention_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__images_sms_attention_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__images_circle_png__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__images_circle_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__images_circle_png__);
...
const utils = {
    ...
    setJuheIconStyle: (len, hover) => {
        return new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.style.Style({
            image: new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.style.Icon(({
                color: hover === 'hover' ? '#3da6f5' : '#F54336',
                src: __WEBPACK_IMPORTED_MODULE_1__images_juhe_png___default.a,
                anchor: [0.5, 1]
            })),
    ...
    setSingleIconStyle: (type, opType, hover) => {
        ...
        if (type === 'cr') {
            src = isAttention ? __WEBPACK_IMPORTED_MODULE_5__images_cr_attention_png___default.a : __WEBPACK_IMPORTED_MODULE_2__images_cr_png___default.a;
        } else if (type === 'lu') {
            src = isAttention ? __WEBPACK_IMPORTED_MODULE_6__images_lu_attention_png___default.a : __WEBPACK_IMPORTED_MODULE_3__images_lu_png___default.a;
        } else if (type === 'sms') {
            src = isAttention ? __WEBPACK_IMPORTED_MODULE_7__images_sms_attention_png___default.a : __WEBPACK_IMPORTED_MODULE_4__images_sms_png___default.a;
        }
        ...
        if (opType.indexOf('today') > -1 || !type || !opType) {
            return new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.style.Style({
                image: new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.style.Icon(({
                    color: color,
                    src: __WEBPACK_IMPORTED_MODULE_8__images_circle_png___default.a,
                    anchor: [0.5, 0.5]
                }))
            })
        } else {
    ...
    getViewGps: (map) => {
        let extent = map.getView().calculateExtent(map.getSize()),
            //上左的坐标
            getTopLeft = __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.transform(__WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.extent.getTopLeft(extent), 'EPSG:3857', 'EPSG:4326'),
            //下右的坐标
            getBottomRight = __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.transform(__WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.extent.getBottomRight(extent), 'EPSG:3857', 'EPSG:4326');
    ...
    formatAreaData: (data) => {
        return data.map(item => {
            if(item.areaType === '2' || item.areaType === 2) {
                ...
                center = __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.fromLonLat(center);
                const location = {
                    center: center,
                ...
                const location = utils.getCoordinates(gpsList).map(d => __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.fromLonLat(d));
                return Object.assign({}, item, {areaLocation: location});
            }
        })
    },
    ...
    /**
     * coordinate转换为经纬度，经度可以大于180或小于-180 （toLonLat 会把不合法的经纬度换成合法的，有时需要不合法坐标）
     * @param coordinate
     */
    toGps: (coordinate) => {
        let gps = __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.toLonLat(coordinate);
    ...
    getCenter: (map, type) => {
        ...
        if (type === 'coordinate') {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.toLonLat(center);
        }
    },
     ...
     */
    setCenter: (map, gps) => {
        const center = __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.fromLonLat([parseFloat(gps[0]), parseFloat(gps[1])]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_openlayers__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_openlayers___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_openlayers__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_utils__ = __webpack_require__(1);
...
const getBtnOverlay = (position, index, showCancelBtn, showSearchBtn) => {
    ...
    return new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.Overlay({
        position: position,
...
const getCircleLayer = (options, geometryData, index, areaData) => {
    let dataOverlay;
    const feature = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.Feature({
        geometry: new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.geom.Circle(geometryData.center, geometryData.radius)
    });
    const source = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.source.Vector({
        features: [feature],
        wrapX: false
    });
    const areaLayer = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.layer.Vector({
        id: index,
        source: source,
        style: function () {
            return __WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].getAreaStyle(options.area.type);
        }
    });
    if (areaData) {
...
const getLinesLayer = (options, geometryData, index, areaData) => {
    ...
    const features = (new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.format.GeoJSON()).readFeatures(geojsonObject);
    const vectorSource = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.source.Vector({
        features: features,
        wrapX: false
    });
    ...
    const areaLayer = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.layer.Vector({
        ...
        source: vectorSource,
        style: function () {
            return __WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].getAreaStyle(areaOption.type);
        }
    });
...
/* harmony default export */ __webpack_exports__["a"] = (getAreaLayer);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__view_renderMap__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__view_heatLayer__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__action_draw__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__view_pointLayer__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__action_trail__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__view_pointModal__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__view_areaLayer__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__event_events__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__event_eventsHandler__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__common_utils__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_openlayers__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_openlayers___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_openlayers__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__images_bubble_png__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__images_bubble_png___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__images_bubble_png__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__css_index_css__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__css_ol_css__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__css_ol_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_13__css_ol_css__);
...
class OlMap {
    constructor(domId) {
        this.domId = domId;
        this.eventsHandler = new __WEBPACK_IMPORTED_MODULE_8__event_eventsHandler__["a" /* default */]();
        this.ol = __WEBPACK_IMPORTED_MODULE_10_openlayers___default.a;
        this.options = {
            mapUrl: '',
            tileLayer: 'iflytek:osm1',
    ...
    setOption(opts) {
        ...
        if (!this.map) {
            this.map = Object(__WEBPACK_IMPORTED_MODULE_0__view_renderMap__["a" /* default */])(this.domId, this.options);
            this.events = new __WEBPACK_IMPORTED_MODULE_7__event_events__["a" /* default */](this.map, this.options, this.eventsHandler);
    ...
    renderHeatLayer() {
        ...
        this.heatLayer = Object(__WEBPACK_IMPORTED_MODULE_1__view_heatLayer__["a" /* default */])(this.options.data);
    ...
    renderPoint() {
        this.removeAllFeature();
        this.pointLayer = Object(__WEBPACK_IMPORTED_MODULE_3__view_pointLayer__["a" /* default */])(this.options);
    ...
    renderPointModal(gps, domId) {
        ...
        this.pointModal = this.pointModal || Object(__WEBPACK_IMPORTED_MODULE_5__view_pointModal__["a" /* default */])(domId, this.options);
        this.pointModal.setPosition(__WEBPACK_IMPORTED_MODULE_10_openlayers___default.a.proj.fromLonLat(gps));
    ...
    startTrail() {
        this.trail && this.trail.cleanTrailLines();
        this.trail = this.trail || Object(__WEBPACK_IMPORTED_MODULE_4__action_trail__["a" /* default */])(this.map, this.options.data, this.eventsHandler);
        this.trail.doPlayTrail();
        this.heatLayer && this.map.removeLayer(this.heatLayer);
        this.map.removeLayer(this.pointLayer);
        this.map.addLayer(this.pointLayer);
    }
    ...
    startDraw(type) {
        ...
        this.draw = Object(__WEBPACK_IMPORTED_MODULE_2__action_draw__["a" /* default */])(type, this.options, this.map, this.eventsHandler);
     ...
     */
    renderArea() {
        const areaData = __WEBPACK_IMPORTED_MODULE_9__common_utils__["a" /* default */].formatAreaData(this.options.area.areaData);
        areaData.forEach((item, i) => {
            let areaLayer = Object(__WEBPACK_IMPORTED_MODULE_6__view_areaLayer__["a" /* default */])(this.options, item.areaLocation, 'area' + i, item);
     ...
     */
    getViewGps() {
        return __WEBPACK_IMPORTED_MODULE_9__common_utils__["a" /* default */].getViewGps(this.map);
    }
     ...
     */
    setCenter(gps) {
        return __WEBPACK_IMPORTED_MODULE_9__common_utils__["a" /* default */].setCenter(this.map, gps);
    }
    ...
    bubbleOverlay(data) {
        ...
        data.map((d, i) => {
            ...
            div.innerHTML =
                `<img src="${__WEBPACK_IMPORTED_MODULE_11__images_bubble_png___default.a}" class="big hiden"/>
                 <img src="${__WEBPACK_IMPORTED_MODULE_11__images_bubble_png___default.a}" class="small"/>`;
            document.body.appendChild(div);

            bubble[i] = new __WEBPACK_IMPORTED_MODULE_10_openlayers___default.a.Overlay({
                element: div,
            ...
            bubble[i].setPosition(__WEBPACK_IMPORTED_MODULE_10_openlayers___default.a.proj.fromLonLat(GPS));
        });
...
const init = (domId) => {
    return new OlMap(domId);
};
window.olMap = {init: init};
...
const getMap = (domId, opts) => {
    const params = {
        LAYERS: opts.tileLayer || 'iflytek:osm1',  // 'iflytek:osm1' 或 'ispp:osm1'
        tiled: true,
        SRS: 'EPSG:3857',
        TRANSPARENT: false
    };
    ...
    //     })
    // });
    const rasterLayer = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.layer.Tile({
        source: new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.source.OSM({wrapX: false})
    });
    const mapCenter = opts.mapCenter || [97.03125, 29.362721750200926];
    return new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.Map({
        layers: [rasterLayer],
        target: domId,
        view: new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.View({
            center: __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.fromLonLat(mapCenter),
            zoom: opts.zoom || 3,
            minZoom: opts.minZoom || 3,
            maxZoom: opts.maxZoom || 20,
            extent: [-20037508.34, -20037508.34, 20037508.34, 20037508.34]
        }),
        controls: __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.control.defaults({
            attributionOptions: {
                collapsible: true
            },
            attribution: false
...
/* harmony default export */ __webpack_exports__["a"] = (getMap);
...
const getHeatLayer = (data) => {
    ...
    for (let i = 0, len = data.length; i < len; i++) {
        heatFeatures.push(new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.Feature({
            geometry: new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.geom.Point(__WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.fromLonLat(gpsData[i])),
            name: 'heatPoint',
    ...
    return new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.layer.Heatmap({
        source: source,
        blur: 15,
        radius: 18
    });
};
/* harmony default export */ __webpack_exports__["a"] = (getHeatLayer);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_openlayers__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_openlayers___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_openlayers__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__view_areaLayer__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_utils__ = __webpack_require__(1);
...
function geometryFunction(coordinates, geometry) {
    if (!geometry) {
        geometry = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.geom.Polygon(null);
    }
...
const getDraw = (type, options, map, eventsHandler) => {
    ...
    switch (type) {
        case 'circle':
            draw = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.interaction.Draw({
                type: 'Circle'
            });
            break;
        case 'polygon':
    ...
    draw.on('drawend', (ev) => {
        ...
        if (type === 'box') {
            // 左上角和右下角坐标
            emitData = [__WEBPACK_IMPORTED_MODULE_2__common_utils__["a" /* default */].toGps(geometryData[0]), __WEBPACK_IMPORTED_MODULE_2__common_utils__["a" /* default */].toGps(geometryData[2])];
        } else if (type === 'circle') {
            // 中心点和半径（单位千米）
            emitData = {
                center: __WEBPACK_IMPORTED_MODULE_2__common_utils__["a" /* default */].toGps(geometryData.center),
                radius: geometryData.radius / 1000
            }
        } else {
            // 所有坐标
            emitData = geometryData.map(coordinate => __WEBPACK_IMPORTED_MODULE_2__common_utils__["a" /* default */].toGps(coordinate));
        }
        ...
        if (drawOption.showArea) {
            areaLayer = Object(__WEBPACK_IMPORTED_MODULE_1__view_areaLayer__["a" /* default */])(options, geometryData, 'draw' + drawNum);
...
/* harmony default export */ __webpack_exports__["a"] = (getDraw);
...
const getPointLayer = (options) => {
    ...
    for (let i = 0; i < len; i++) {
        ...
        const feature = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.Feature({
            ...
            type_ope: item.type,
            pointGPS: __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.fromLonLat(GPS),
            geometry: new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.geom.Point(__WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.fromLonLat(GPS))
        });
        feature.setStyle(__WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].styleFunction(feature));
    ...
    return new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.layer.Vector({
        source: source,
        wrapX: false,
        // style: utils.styleFunction 不建议用此用法，此用法会循环3倍
    });
};

/* harmony default export */ __webpack_exports__["a"] = (getPointLayer);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_openlayers__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_openlayers___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_openlayers__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__arc__ = __webpack_require__(19);
...
const PlayTrail = function (opt_options) {
    ...
    this.lineStyle = _options.lineStyle || new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.style.Style({
            stroke: new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.style.Stroke({
                color: '#0000FF',
                width: 2
            }),
    ...
    this.markStyle = _options.markStyle || new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.style.Style({
            image: new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.style.Circle({
                radius: 7,
                snapToPixel: false,
                fill: new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.style.Fill({
                    color: 'red'
    ...
    this.map = _options.map || new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.Map({
            layers: [new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.layer.Tile({
                source: new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.source.OSM()
            })],
            target: 'map',
            view: new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.View({
                center: __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.transform([117.28, 31.86], 'EPSG:4326',
                    'EPSG:3857'),
                zoom: 5
            })
        });
...
PlayTrail.prototype.animateTrail = function (event) {
    ...
    var features = $THIS.lineFeatures;
    var zoom = $THIS.map.getView().getZoom();
    // 箭头的高度
    var unitDistance = 10000 * Math.pow(2, 5 - zoom);
    var arrowHeight = 5 * unitDistance;
    var lineLength = 0;
    ...
    for (var j = 0; j < features.length; j++) {
        for (var i = 0; i < features[j].length; i++) {
            var feature = features[j][i];
            if (!feature.get('finished')) {
                ...
                var currentLine = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.geom.LineString(coords.slice(0, maxIndex));
                vectorContext.drawGeometry(currentLine);

                // 画箭头
                var endIndex = Math.floor(Math.min(elapsedPoints, coords.length - 1));
                if (endIndex > 2) {
                    var mIndex = Math.max(0, endIndex - 1);
                    mIndex = Math.floor(mIndex);
                    if (endIndex > mIndex) {
                        var arrow = $THIS.genArrow(coords[mIndex], coords[endIndex], arrowHeight);
                ...
                if (elapsedPoints >= coords.length) {
                    ...
                    if (feature.secondLine) {
                        var nextLineFeature = feature.secondLine;
                        nextLineFeature.set('started', true);
                        nextLineFeature.set('start', new Date().getTime());
                    } else {
                        var targetPoint = feature.get('targetPoint');
                        targetPoint.trailStatus = TrailStatus.STOPED;
                        var nextLineFeature = targetPoint.get('line');
                        if (nextLineFeature) {
                            nextLineFeature.set('started', true);
                            nextLineFeature.set('start', new Date().getTime());
                            var nextPoint = nextLineFeature.get('targetPoint');
                ...
                vectorContext.drawGeometry(new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.geom.LineString(coors));
                // 画箭头
                var targetPoint = feature.get('targetPoint');
                // var radius = targetPoint.getStyle().getImage().getRadius();
                var radius = 7;
                var distance = radius * unitDistance / 2;
                var targetCoords = targetPoint.getGeometry().getCoordinates();
                var halfLen = coors.length / 2;
                var _index = coors.length - 1;
                var _line;
                for (_index = coors.length - 1; _index >= 0; --_index) {
                    _line = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.geom.LineString([coors[_index], targetCoords]);
                ...
                // 画箭头
                if (distance < _line.getLength()) {
                    var rIdx = Math.max(0, _index - 1);
                    var ratio = distance / _line.getLength();
                    var arrowHead = [];
                    arrowHead[0] = targetCoords[0] - (targetCoords[0] - coors[rIdx][0]) * ratio;
                    arrowHead[1] = targetCoords[1] - (targetCoords[1] - coors[rIdx][1]) * ratio;
                    var arrow = $THIS.genArrow(coors[rIdx], arrowHead, arrowHeight);
                    vectorContext.drawGeometry(arrow);
                } else {
                    var arrowIdx = Math.max(0, _index);
                    var rIdx = Math.max(0, arrowIdx - 1);
                    if (arrowIdx > rIdx) {
                        var arrow = $THIS.genArrow(coors[rIdx], coors[arrowIdx],
                            arrowHeight);
                        vectorContext.drawGeometry(arrow);
                    }
                }
 ...
 */
PlayTrail.prototype.genArrow = function (rPoint, endPoint, arrowHeight) {
    //箭头底和高的交点位置
    var mPoint = [];
    //头与交点的位移差
    var diffX, diffY;
    ...
    //头与参照点的距离
    var rlength = Math.sqrt(rdiffX * rdiffX + rdiffY * rdiffY);
    //头与交点的位移差
    ...
    // 三角形箭头的底的一半长度
    var halfBottomLen = arrowHeight / 3;
    // 箭头的另外两个顶点
    var point1 = [],
        point2 = [];
    var _x = halfBottomLen * Math.abs(diffY / arrowHeight);
    var _y = halfBottomLen * Math.abs(diffX / arrowHeight);
    if (diffY == 0) {
        point1[0] = mPoint[0];
    ...
    return new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.geom.Polygon([
...
PlayTrail.prototype.animatePoint = function (pointFeature, animateDuaration) {
    ...
    $THIS._animatePoint = function (event) {
        if (pointFeature.trailStatus === TrailStatus.STOPED) {
            __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.Observable.unByKey(listenerKey);
            return;
        }
        var vectorContext = event.vectorContext;
        var frameState = event.frameState;
        var flashGeom = pointFeature.getGeometry().clone();
        flashGeom.A = __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.transform(pointFeature.coordinates, 'EPSG:4326', 'EPSG:3857');
        var elapsed = frameState.time - start;
        var elapsedRatio = elapsed / animateDuaration;
        var radius = __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.easing.easeOut(elapsedRatio) * 25 + 3;
        var opacity = __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.easing.easeOut(1 - elapsedRatio);

        var style = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.style.Style({
            image: new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.style.Circle({
                radius: radius,
                snapToPixel: false,
                stroke: new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.style.Stroke({
...
PlayTrail.prototype.doPlayTrail = function () {
    $THIS.status = 'started';
    var pointStore = $THIS.pointsFeatureStore;
    for (var k = 0; k < pointStore.length; k++) {
    ...
    for (var k = 0; k < pointStore.length; k++) {
        // 初始点
        var startPoint = pointStore[k][0].coordinates,
            endPoint;
        var _duration = $THIS.duration;
        if (pointStore[k].length > 1) {
            var _lines = [];
            for (var i = 1; i < pointStore[k].length; i++) {
                endPoint = pointStore[k][i].coordinates;
                var arcGenerator = new __WEBPACK_IMPORTED_MODULE_1__arc__["a" /* default */].GreatCircle({
                    x: startPoint[0],
                    y: startPoint[1]
                }, {
                    x: endPoint[0],
                ...
                arcLine.geometries.forEach(function (geometry, _idx) {
                    var line = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.geom.LineString(geometry.coords);
                    line.transform(__WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.get('EPSG:4326'), __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.get('EPSG:3857'));
                    var lineFeature = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.Feature({
                        geometry: line,
                        finished: false,
                        started: false,
    ...
    postcompose = $THIS.map.on('postcompose', $THIS.animateTrail);
            ...
            if (GLOBAL.NUM <= $THIS.lineFeatures.length - 1) {
                if (GLOBAL.NUM <= $THIS.lineFeatures.length - 1) {
                    if ($THIS.lineFeatures[GLOBAL.NUM].length > 0) {
                        var feature = $THIS.lineFeatures[GLOBAL.NUM][0];
...
PlayTrail.prototype.cleanTrailLines = function (num) {
    var pointLength = $THIS.pointsFeatureStore.length;
    $THIS.trailStatus.setStatus(TrailStatus.START);
    var length = 0;
    for (var i = pointLength - num; i < pointLength; i++) {
...
PlayTrail.prototype.backTrail = function (time) {
    var backTime = GLOBAL.MAX_TIME - parseInt(time);
    for (var i = 0; i < $THIS.lineFeatures.length; i++) {
...
PlayTrail.prototype.runTrail = function (time) {
    var backTime = GLOBAL.MIN_TIME - parseInt(time);
    for (var i = 0; i < GLOBAL.BACK_LIST.length; i++) {
...
const formatData = (data) => {
    const terminalArr = [];
    const trailData = [];
    const format = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.format.GeoJSON();
    for (var i = 0, len = data.length; i < len; i++) {
        var terminalId = data[i].prop_terminalId;
        var terminalIndex = terminalArr.indexOf(terminalId);
        if (terminalIndex < 0) {
        ...
        point.coordinate = __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.proj.fromLonLat(gps);
 ...
 * @returns {PlayTrail}
 */
/* harmony default export */ __webpack_exports__["a"] = ((map, data, eventsHandler) => {
...
/* harmony default export */ __webpack_exports__["a"] = (getPointModal);
...
class Events {
    constructor(map, options, eventsHandler) {
        ...
        this.hoverPoints = [];   // 悬浮选中的点
        this.areaOverlay = null; // ol select 事件
    }

    clickEvent(ev) {
        const feature = ev.map.forEachFeatureAtPixel(ev.pixel, (point) => point);
        const pointFlag = feature && feature.N.name === 'point',
            flag = !this.lastClick ? pointFlag : pointFlag && feature.N.aggreGPS !== this.lastClick.N.aggreGPS;
        this.areaClick(ev);
        if (!flag) {
            return;
        }
        const num = feature.N.aggreCount || 1,
            type = feature.N.type,
            type_ope = feature.N.type_ope;
        const style = num === 1 ? __WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].setSingleIconStyle(type, type_ope, 'hover') : __WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].setJuheIconStyle(num, 'hover');
        ...
        if (this.lastClick) {
            ...
            lastClick.setStyle(count === 1 ? __WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].setSingleIconStyle(lastClick.N.type, lastClick.N.type_ope) : __WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].setJuheIconStyle(count));
        }
    ...
    closePointModal(pointModal) {
        ...
        if (num === 1) {
            ...
            this.lastClick.setStyle(__WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].setSingleIconStyle(type, this.lastClick.N.type_ope));
        } else {
            this.lastClick.setStyle(__WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].setJuheIconStyle(num));
        }
    ...
    getSelectInteraction() {
        const selectInteraction = new __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.interaction.Select({
            wrapX: false,
            condition: __WEBPACK_IMPORTED_MODULE_0_openlayers___default.a.events.condition.pointerMove,
            filter: function (e) {
                return e.N.name === 'point' || e.dataOverlay;
            }
        });
        selectInteraction.on('select', (e) => {
            if (e.selected.length) { // 移入点
                const selP = e.selected[0],
                    num = selP.N.aggreCount || 1,
                    geometry = selP.N.geometry,
                ...
                if (this.hoverPoints.length) {
                    ...
                    if (isNotLastClick && P.N.name === 'point') {
                        if (!P.N.aggreCount || P.N.aggreCount === 1) {
                            P.setStyle(__WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].setSingleIconStyle(P.N.type, P.N.type_ope));
                        } else {
                            P.setStyle(__WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].setJuheIconStyle(P.N.aggreCount));
                        }
                    }
                }
                ...
                if (this.areaOverlay) {
                    this.areaOverlay.targetFeature.setStyle(__WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].getAreaStyle(this.options.area.type));
                    this.map.removeOverlay(this.areaOverlay);
                }

                // 移入区域
                if (geometry && dataOverlay) {
                    selP.setStyle(__WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].getAreaStyle(this.options.area.type, true));
                    this.map.addOverlay(dataOverlay);
                    this.areaOverlay = dataOverlay;
                }

                // 移入点
                if (selP.N.name === 'point') {
                    if (num === 1) {
                        selP.setStyle(__WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].setSingleIconStyle(selP.N.type, selP.N.type_ope, 'hover'));
                    } else {
                        selP.setStyle(__WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].setJuheIconStyle(num, 'hover'));
                    }
                    this.hoverPoints = [selP];
                }

            } else if (e.deselected.length) { // 移出点
                const deSelP = e.deselected[0],
                    num = deSelP.N.aggreCount || 1,
                    geometry = deSelP.N.geometry,
                    dataOverlay = deSelP.dataOverlay;

                // 移出区域
                if (geometry && dataOverlay) {
                    deSelP.setStyle(__WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].getAreaStyle(this.options.area.type));
                ...
                if (isNotLastClick && deSelP.N.name === 'point') {
                    if (num === 1) {
                        deSelP.setStyle(__WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].setSingleIconStyle(deSelP.N.type, deSelP.N.type_ope));
                    } else {
                        deSelP.setStyle(__WEBPACK_IMPORTED_MODULE_1__common_utils__["a" /* default */].setJuheIconStyle(num));
                    }
                }
                this.hoverPoints = [];
            }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = EventsHandler;
