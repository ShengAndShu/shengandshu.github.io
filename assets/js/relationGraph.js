...
const utils = {
    ...
    getNodeStyle: function (node) {
        ...
        // const color = node.isSelected ? option.nodeTextColHigh
        //     : ((!option.showCritical || node.isCritical) ? option.nodeTextColNorm : option.nodeTextColDark);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return echarts; });
        ...
        if (window.addEventListener) {
            ...
            if (env.os.tablet || env.os.phone) {
                ...
                root.addEventListener('mousemove', function(e) {
                    that._mousemoveHandler(e, 'default');
                });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__assets_js_echarts_callsAnls__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__event_chartEvent_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__event_drawEvent_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__event_eventHandler__ = __webpack_require__(2);
...
class RelationGraph {
    constructor(el) {
        this.utils = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */];
        this.forceChart = __WEBPACK_IMPORTED_MODULE_0__assets_js_echarts_callsAnls__["c" /* echarts */].init(el);
        // 绑定chartEvent
        for (let ev in __WEBPACK_IMPORTED_MODULE_2__event_chartEvent_js__["a" /* default */]) {
            this.forceChart.un(__WEBPACK_IMPORTED_MODULE_0__assets_js_echarts_callsAnls__["b" /* config */].EVENT[ev], __WEBPACK_IMPORTED_MODULE_2__event_chartEvent_js__["a" /* default */][ev]);
            this.forceChart.on(__WEBPACK_IMPORTED_MODULE_0__assets_js_echarts_callsAnls__["b" /* config */].EVENT[ev], __WEBPACK_IMPORTED_MODULE_2__event_chartEvent_js__["a" /* default */][ev]);
        }

        const _domRoot = this.forceChart._zr.painter._domRoot;
        _domRoot.oncontextmenu = () => false;
        _domRoot.appendChild(__WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].rectDom);  // 添加矩形dom，用来框选
    }
    ...
    setOption(option) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].option = Object.assign(__WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].option, option);
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].delStore = [];
        // 若传节点数据，则先清空，再重新setOption
        if (!force || leafData.length || data.length || rootData.length) {
            const size = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getLayoutSize(rootData.length + data.length);
            const chartOption = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getChartOption(size, [], []);
            // 清空上次的数据
            __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].delStore = [];
            this.forceChart.clear();
            // setOption
            this.forceChart.setOption(chartOption);
            __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].force = this.forceChart.chart.force;
            // 添加数据
            this.addRootNodes(rootData, false);
            this.addNodesLinks(data, false);
            this.addNodesLinks(leafData, true);
            const series = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].force.series[0];
            series.nodes = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].formatNodes(series.nodes);
            series.links = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].formatLinks(series.links);
            __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].force.refresh();

        } else {
            const force = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].force;
            if (!force) return;
            const series = force.series[0];
        ...
        __WEBPACK_IMPORTED_MODULE_4__event_eventHandler__["a" /* default */].oncountchange(__WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].force._graph.nodes.map(d => d.id));
    }
    ...
    addRootNodes(rootData, onlyRootData) {
        ...
        for (let i = 0, len = rootData.length; i < len; i++) {
            ...
            node.itemStyle = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getNodeStyle(node);
            node.symbol = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getNodeImage(node);
            node.z = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getNodeZ(node);
            node.isCritical = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getNodeCritical(node);
            nodes.push(node);
            nameList.push(node.name);
        }
        needDeeplyDel.length && this.deeplyDelete(needDeeplyDel);
        if (onlyRootData) {
            __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].option.rootData = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].option.rootData.concat(rootData);
            force.fixed = false;
            force.refresh();
            __WEBPACK_IMPORTED_MODULE_4__event_eventHandler__["a" /* default */].oncountchange(__WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].force._graph.nodes.map(d => d.id));
        }
     ...
     */
    on(eventType, cb) {
        __WEBPACK_IMPORTED_MODULE_4__event_eventHandler__["a" /* default */]['on' + eventType] = cb;
    }
    ...
    deleteNodes(nameList) {
        ...
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].deleteRect();
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].refresh();
        const singleDel = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].delSingleNode();     // 节点删除后画布可能会出现孤立节点，一并删除
        delList = [...delList, ...singleDel];
        if (delList.length > 0) {
            if (__WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].delStore.length === __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].option.deleteCacheLength) {
                this.deeplyDelete(__WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].delStore.shift());
            }
            __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].delStore.push(delList);
            __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].refresh();
            __WEBPACK_IMPORTED_MODULE_4__event_eventHandler__["a" /* default */].oncountchange(__WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].force._graph.nodes.map(d => d.id));
            __WEBPACK_IMPORTED_MODULE_4__event_eventHandler__["a" /* default */].ondeletenodes(delList);
        }
        return delList;
    }
     ...
     */
    revertLastDel() {
        if (__WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].delStore.length === 0) {
            return;
        }
        const lastDel = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].delStore[__WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].delStore.length - 1];
        this.revertDel(lastDel);
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].delStore.pop();
    }
     ...
     */
    revertDel(nameList) {
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].revertDel(nameList);
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].refresh();
        __WEBPACK_IMPORTED_MODULE_4__event_eventHandler__["a" /* default */].oncountchange(__WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].force._graph.nodes.map(d => d.id));
        __WEBPACK_IMPORTED_MODULE_4__event_eventHandler__["a" /* default */].onrevert(nameList);
    }
    ...
    deeplyDelete(names) {
        const force = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].force;
        if (!force) return;
        names = names || __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].delStore[0] || [];
    ...
    drawRect() {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].isDrawing || force.dragBox) {
            this.deleteRect();
            __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].refresh();
            return;
        }
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].isDrawing = true;
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].force.zr.handler.isDrawing = true;   // 变换鼠标样式
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].setRoam(false, false, true);   // 禁用画布拖动和缩放
        dom.addEventListener('mousedown', __WEBPACK_IMPORTED_MODULE_3__event_drawEvent_js__["a" /* default */].mousedown);
    }
    ...
    deleteRect() {
        ...
        if (!force) return;
        const dom = force.zr.painter._domRoot;
        dom.removeEventListener('mousedown', __WEBPACK_IMPORTED_MODULE_3__event_drawEvent_js__["a" /* default */].mousedown);
        dom.removeEventListener('mousemove', __WEBPACK_IMPORTED_MODULE_3__event_drawEvent_js__["a" /* default */].mousemove);
        dom.removeEventListener('mouseup', __WEBPACK_IMPORTED_MODULE_3__event_drawEvent_js__["a" /* default */].mouseup);
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].deleteRect();
    }
    ...
    markNodes() {
        ...
        for (let i = 0, l = nodes.length; i < l; i++) {
            ...
            if (node.isSelected) {
                ...
                node.itemStyle = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getNodeStyle(node);  // 取消高亮
                node.symbol = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getNodeImage(node);     // 更换图片
            }
        }
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].deleteRect();
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].refresh();
    ...
    searchNode(name) {
        ...
        for (let i = 0, l = nodes.length; i < l; i++) {
            ...
            if (node.isSearched) {      // 上一个被搜索的节点样式还原
                ...
                node.z = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getNodeZ(node);
                node.itemStyle = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getNodeStyle(node);   // 取消高亮
                node.symbolSize = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getNodeSize(node);   // 图片大小恢复
                if (name === '') {
                    break;
                }
            }
            if (node.name === name) {   // 当前被选中的节点变更样式
                ...
                node.z = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getNodeZ(node);
                node.itemStyle = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getNodeStyle(node);   // 文字高亮
                node.symbolSize = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getNodeSize(node);   // 图片放大
                __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].setNodeCenter(name);
            }
        }
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].refresh();
    }
     ...
     */
    filter(fun) {
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].filter(fun);
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].delStore = [];
        __WEBPACK_IMPORTED_MODULE_4__event_eventHandler__["a" /* default */].oncountchange(__WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].force._graph.nodes.map(d => d.id));
    }
    ...
    layout() {
        ...
        series.gravity = .8;
        series.size = __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getLayoutSize(force._layout.graph.nodes.length);
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].deleteRect();
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].refresh();
    }
    ...
    clear() {
        this.forceChart.clear();
        this.forceChart.setOption(__WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].getChartOption('100%', [], []));
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].force = this.forceChart.chart.force;
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].delStore = [];
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].isDrawing = false;
        __WEBPACK_IMPORTED_MODULE_4__event_eventHandler__["a" /* default */].oncountchange([]);
    }
     ...
     */
    toogleCritical() {
        __WEBPACK_IMPORTED_MODULE_1__utils_utils_js__["a" /* default */].toggleCritical();
    }
}

const init = (element) => {
    return new RelationGraph(element);
};
window.relationGraph = {init: init};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__eventHandler__ = __webpack_require__(2);



const chartEvent = {
    FORCE_LAYOUT_END: function () {
        const nodes = __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].force.series[0].nodes || [];
        ...
        __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].force.fixed = true;
        __WEBPACK_IMPORTED_MODULE_1__eventHandler__["a" /* default */].onforcelayout();
        //setNodeCenter
    },
    // 单击
    CLICK: function (param) {
        const data = param.data;
        __WEBPACK_IMPORTED_MODULE_1__eventHandler__["a" /* default */].onclick(param);
        // 单击只针对节点有效，线条单击无效
        if (!data.source && !data.target) {
            const force = __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].force,
                layer = force.zr.painter.getLayer(force.zlevel),
            ...
            if (data.hasLeaf &&
                ...
                if (data.showLeaf) {
                    //收缩节点
                    __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].toggleLeaf(data.name, true);
                    __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].refresh();
                } else {
                    //展开节点
                    const series = force.series[0],
                        center = series.center,
                        gravity = series.gravity;
                    __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].toggleLeaf(data.name, false);
                    if (__WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].filterFun) {
                        __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].filter(__WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].filterFun);
                    } else {
                        __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].refresh();
                    }
                    __WEBPACK_IMPORTED_MODULE_1__eventHandler__["a" /* default */].onshowleaf();
                    series.center = center;   // 恢复簇状布局的影响
                    series.gravity = gravity;   // 恢复簇状布局的影响
                }
                __WEBPACK_IMPORTED_MODULE_1__eventHandler__["a" /* default */].oncountchange(__WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].force._graph.nodes.map(d => d.id));
            } else {
                // 节点高亮
                data.isSelected = !data.isSelected;
                data.itemStyle = __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].getNodeStyle(data);
                __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].refresh();
            }
        }
    },
    ...
    CONTEXTMENU: function (param) {
        __WEBPACK_IMPORTED_MODULE_1__eventHandler__["a" /* default */].oncontextmenu(param);
    }
};
/* harmony default export */ __webpack_exports__["a"] = (chartEvent);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assets_js_echarts_callsAnls__ = __webpack_require__(1);
...
const drawEvent = {
    mousedown: function(ev) {
        const dom = __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].force.zr.painter._domRoot,
    ...
    mousemove: function(ev) {
        const dom = __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].force.zr.painter._domRoot,
            domPos = dom.getBoundingClientRect(),
            rectDom = __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].rectDom;
        const x1 = rectPos.x1,
            y1 = rectPos.y1,
    ...
    mouseup: function() {
        ...
        force.dragBox = new __WEBPACK_IMPORTED_MODULE_1__assets_js_echarts_callsAnls__["a" /* Rectangle */]({               //添加矩形shape模拟选框
            style: {
                x: p.x1,
                y: p.y1,
                width: p.x2 - p.x1,
        ...
        __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].setRoam(true, true, false);            // 恢复画布拖动和缩放
        __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].refresh();
        ...
        __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].isDrawing = false;
        __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].force.zr.handler.isDrawing = false;   // 变换鼠标样式
        __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].rectDom.style.height = '0';
    },
    dblclick: function () {
        const dom = __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].force.zr.painter._domRoot;
        __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].deleteRect();
        __WEBPACK_IMPORTED_MODULE_0__utils_utils_js__["a" /* default */].refresh();
        dom.removeEventListener('dblclick', drawEvent.dblclick);
    }
};

/* harmony default export */ __webpack_exports__["a"] = (drawEvent);
